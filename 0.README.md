...
Repositório com código Python, figuras, dados e LaTeX para o paper: [Ler PDF no Zenodo](https://zenodo.org/doi/10.5281/zenodo.XXXXXXX).

## Conteúdo
- `run_beta_sweep_von_neumann.py`: Script principal para análise de phase behavior.
- Figuras: Plots de dominance ratio e von Neumann entropy.
- `main.tex`: Fonte LaTeX do paper.

Reproducível com Python 3.12 + NumPy/SciPy/Matplotlib.
# Informational Condensation in the Rank-1 Limit: Emergence of Causal Order from a Pre-Geometric Substrate

[![DOI](https://zenodo.org/badge/DOI/10.5281/zenodo.17862884.svg)](https://doi.org/10.5281/zenodo.17862884)  
[![License: CC BY 4.0](https://img.shields.io/badge/License-CC%20BY%204.0-lightgrey.svg)](https://creativecommons.org/licenses/by/4.0/)

Paper (preprint) + código-fonte + figuras + notebook Colab da pesquisa sobre condensação causal em sistemas pré-geométricos.

R.L. FonteLES – Independent researcher – Dezembro 2025

→ [Ler o paper completo (PDF)](https://zenodo.org/records/14789234/files/Causal_Condensation_...pdf)
# Informational Condensation in the Rank-1 Limit: Emergence of Causal Order from a Pre-Geometric Substrate
